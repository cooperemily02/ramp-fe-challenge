...
export function App() {
  ...
  const [isLoading, setIsLoading] = useState({employees: false, transactions: false})
  ...
  const loadAllTransactions = useCallback(async () => {
    setIsLoading({employees: true, transactions: true})
    transactionsByEmployeeUtils.invalidateData()

    await employeeUtils.fetchAll().then(
    ...
    <Fragment>
      <main className="MainContainer">
        ...
        <div className="RampGrid">
          ...
          {paginatedTransactions && paginatedTransactions.nextPage && transactions !== null && (
            <button
